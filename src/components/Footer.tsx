        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-gray-400">
              ...
              <li>
                <a href="#characters" className="hover:text-purple-400 transition-colors duration-300">
                  Character Gallery
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="#pricing" className="hover:text-purple-400 transition-colors duration-300">
                  Pricing
                </a>
              </li>
              <li>
                <a href="#faq" className="hover:text-purple-400 transition-colors duration-300">
                  FAQ
                </a>
              </li>
              <li>
                <a href="/track-order" className="hover:text-purple-400 transition-colors duration-300">
                  Track Your Order
                </a>
              </li>
            </ul>
          ...
          {/* Shop & Support */}
          <div className="space-y-4">
            <h4 className="text-lg font-semibold text-white">Shop & Support</h4>
            <ul className="space-y-3 text-gray-400">
              <li>
                <a 
              ...
              <li>
                <a href="/support" className="hover:text-purple-400 transition-colors duration-300">
                  Customer Support
                </a>
              </li>
              <li>
                <a href="/returns" className="hover:text-purple-400 transition-colors duration-300">
                  Returns & Refunds
                </a>
              </li>
              <li>
                <a href="/wholesale" className="hover:text-purple-400 transition-colors duration-300">
                  Bulk Orders
                </a>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            {/* Social Media */}
            <div className="pt-2">
              <p className="text-sm text-gray-400 mb-3">Follow our attitude:</p>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              ...
              <div className="flex gap-2 w-full md:w-auto">
                <input
                  ...
                  className="px-4 py-2 rounded-lg flex-1 md:w-64 text-gray-900"
                />
        ...
        <div className="container">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="text-gray-400 text-sm">
              ...
              <span className="font-medium text-gray-300"> Made with ❤️ in India</span>
            </div>
            ...
            <div className="flex space-x-4 text-sm text-gray-400">
              ...
              <span>•</span>
              <a href="/refund" className="hover:text-purple-400 transition-colors">
                Refund Policy
              </a>
            </div>
          </div>
